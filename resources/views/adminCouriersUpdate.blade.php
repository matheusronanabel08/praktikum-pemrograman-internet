  ...
  <div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
      ...
      <div class="container" style="margin-top: 25px;">
        ...
        <form action="/adminCouriers/update/{{$couriers -> id}}" method="POST">
          ...
          <input type="text" class="form-control" name="courierName" placeholder="Enter Courier Name" value="{{$couriers -> courier}}">
