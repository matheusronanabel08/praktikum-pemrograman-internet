			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 js-show-cart" onClick="multiplyBy()">
                ...
                @foreach ($products as $products)
                    <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                        ...
                        <div class="block2">
                            ...
                            <a href="/productsDetail/detail/{{$products->id}}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
                                    Detail
                                </a>
                            </div>
			...
			<div class="header-cart-content flex-w js-pscroll">
                        ...
                        @foreach ($carts as $cart)
                            <li class="header-cart-item flex-w flex-t m-b-12">
                                <div class="header-cart-item-img">
                                    <img src="{{asset('assets/images/seringai.jpg')}}" alt="IMG">
                                </div>
                                    ...
                                    <div class="header-cart-item-txt p-t-8">
                                        ...
                                        <span class="header-cart-item-info">
                                            <span id="price"><input type="hidden" id="price" value="{{$cart->price}}">{{$cart->price}}</span> x <span id="quantity"><input type="hidden" value="{{$cart->qty}}" id="quantity">{{$cart->qty}}</span>
                                        </span>
				...
				<div class="w-full">
					<div class="header-cart-buttons flex-w w-full">
						<a href="/productsCheckout" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">
							Check Out
                        </a>
					</div>
				</div>
